...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Bewijs:
            \begin{enumerate}
                \item Eigenschap twee volgt uit eigenschap één: als er nog een vergrotende weg te vinden is in het restnetwerk kan de netwerkstroom $f$ zeker groter gemaakt worden.
                \item Eigenschap drie volgt uit eigenschap twee: beschouw een snede $(P, V)$ waarbij $P$ de knopen bevat in het restnetwerk bereikbaar van $p$. Er is geen vergrotende weg dus $v$ behoort niet tot $P$. Er moet $f(P, V) = c(P, V)$ want als
                ...
                \item Eigenschap één volgt uit eigenschap drie: de netwerkstroom is gelijk aan de nettostroom doorheen elke snede, en de nettostroom van de snede hierboven is maximaal $(f(P, V) = c(P, V))$.
            \end{enumerate}
        \end{itemize}
    \end{itemize}
