...
// Waarom inline? Anders kans op linker error: multiple definitions
// Moet ook bij template specializations
//
// https://stackoverflow.com/questions/4445654/multiple-definition-of-template-specialization-when-using-different-objects
//
inline std::ostream& operator<<(std::ostream& os, const GraafExceptie& exc)
{
    return os << exc.what();
}
...
public:
    ...
    const Burenlijst& operator[](int i) const
    {
        return knopen[i];
    }
    ...
    Graaf(const Graaf& andere) = default;
    Graaf(Graaf&& andere) = default;
    Graaf& operator=(const Graaf& andere) = default;
    Graaf& operator=(Graaf&& andere) = default;
    virtual ~Graaf() = default;
...
template <>
inline std::string Graaf<GERICHT>::genereer_dot_code() const
{
...
template <>
inline bool Graaf<ONGERICHT>::isGericht() const
{
    return false;
...
int Graaf<RT>::verbindingsnummer(int van, int naar) const
{
    controleerKnoopnummer(van);
    controleerKnoopnummer(naar);
    Burenlijst::const_iterator verbindingit = knopen[van].find(naar);
...
{
    os << "knoop " << k << ":" << std::endl;
    for (const auto& [key, value] : knopen[k])
    {
        os << "  ->" << key;
        schrijfVerbinding(os, value);
    }
}
...
public:
    ...
    GraafMetTakdata(const GraafMetTakdata& andere) = default;
    GraafMetTakdata(GraafMetTakdata&& andere) = default;
    GraafMetTakdata& operator=(const GraafMetTakdata& andere) = default;
    GraafMetTakdata& operator=(GraafMetTakdata&& andere) = default;
    virtual ~GraafMetTakdata() = default;
...
public:
    ...
    GraafMetKnoopdata(const GraafMetKnoopdata& andere) = default;
    GraafMetKnoopdata(GraafMetKnoopdata&& andere) = default;
    GraafMetKnoopdata& operator=(const GraafMetKnoopdata& andere) = default;
    GraafMetKnoopdata& operator=(GraafMetKnoopdata&& andere) = default;
    virtual ~GraafMetKnoopdata() = default;
...
void GraafMetKnoopdata<RT, Knoopdata>::schrijfKnoop(std::ostream& os, int k) const
{
    ...
    for (const auto& [key, value] : this->knopen[k])
    {
        os << "  ->" << key;
        this->schrijfVerbinding(os, value);
    }
}
...
public:
    ...
    GraafMetKnoopEnTakdata(const GraafMetKnoopEnTakdata& andere) = default;
    GraafMetKnoopEnTakdata(GraafMetKnoopEnTakdata&& andere) = default;
    GraafMetKnoopEnTakdata& operator=(const GraafMetKnoopEnTakdata& andere) = default;
    GraafMetKnoopEnTakdata& operator=(GraafMetKnoopEnTakdata&& andere) = default;
    virtual ~GraafMetKnoopEnTakdata() = default;
};
