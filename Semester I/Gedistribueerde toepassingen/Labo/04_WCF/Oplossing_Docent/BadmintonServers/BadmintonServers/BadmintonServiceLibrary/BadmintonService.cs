    ...
    public class BadmintonService : IBadmintonService
    {
        ...
        BadmintonService()
        {
            ...
            Mapper.Initialize(cfg => {
                cfg.CreateMap<BadmintonInterface.SportClub, SportClub>();
                cfg.CreateMap<BadmintonInterface.Tornooi, Tornooi>();
                cfg.CreateMap<BadmintonInterface.Lid, Lid>();
            });
        ...
        {
            SportClub[] badmintonClubs = Mapper.Map<BadmintonInterface.SportClub[], SportClub[]>(clubs);
        ...
        {
            Tornooi[] webTornooien = Mapper.Map<IList<BadmintonInterface.Tornooi>, Tornooi[]>(tornooien);
        ...
        {
            Lid[] webLeden = Mapper.Map<BadmintonInterface.Lid[], Lid[]>(leden);
