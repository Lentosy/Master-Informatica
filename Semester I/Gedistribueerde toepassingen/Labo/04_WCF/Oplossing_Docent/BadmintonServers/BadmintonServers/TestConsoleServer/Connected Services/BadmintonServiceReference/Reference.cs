...
namespace TestConsoleServer.BadmintonServiceReference {
    ...
    public partial class SportClub : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private TestConsoleServer.BadmintonServiceReference.Tornooi[] TornooienField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public TestConsoleServer.BadmintonServiceReference.Tornooi[] Tornooien {
            get {
    ...
    public interface IBadmintonService {
        ...
        TestConsoleServer.BadmintonServiceReference.SportClub[] GetSportClubs();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBadmintonService/GetSportClubs", ReplyAction="http://tempuri.org/IBadmintonService/GetSportClubsResponse")]
        System.Threading.Tasks.Task<TestConsoleServer.BadmintonServiceReference.SportClub[]> GetSportClubsAsync();
        ...
        TestConsoleServer.BadmintonServiceReference.Lid[] GetLeden(int sportclubID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBadmintonService/GetLeden", ReplyAction="http://tempuri.org/IBadmintonService/GetLedenResponse")]
        System.Threading.Tasks.Task<TestConsoleServer.BadmintonServiceReference.Lid[]> GetLedenAsync(int sportclubID);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IBadmintonServiceChannel : TestConsoleServer.BadmintonServiceReference.IBadmintonService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class BadmintonServiceClient : System.ServiceModel.ClientBase<TestConsoleServer.BadmintonServiceReference.IBadmintonService>, TestConsoleServer.BadmintonServiceReference.IBadmintonService {
        ...
        public TestConsoleServer.BadmintonServiceReference.SportClub[] GetSportClubs() {
            return base.Channel.GetSportClubs();
        }
        
        public System.Threading.Tasks.Task<TestConsoleServer.BadmintonServiceReference.SportClub[]> GetSportClubsAsync() {
            return base.Channel.GetSportClubsAsync();
        }
        
        public TestConsoleServer.BadmintonServiceReference.Lid[] GetLeden(int sportclubID) {
            return base.Channel.GetLeden(sportclubID);
        }
        
        public System.Threading.Tasks.Task<TestConsoleServer.BadmintonServiceReference.Lid[]> GetLedenAsync(int sportclubID) {
