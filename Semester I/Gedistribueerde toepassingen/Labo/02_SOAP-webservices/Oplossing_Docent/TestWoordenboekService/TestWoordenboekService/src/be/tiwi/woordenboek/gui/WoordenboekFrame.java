...
import be.tiwi.woordenboek.impl.WoordenboekDAOService;
...
public class WoordenboekFrame extends javax.swing.JFrame {
    ...
    public WoordenboekFrame() {
        initComponents();
        try {
            woordenboekDAO = new WoordenboekDAOService(); //new WoordenboekDAODummy();
            ...
            woordenLijst.setListData(new Vector<>());
            definitieLijst.setListData(new Vector<>());
        } catch (Exception e) {
