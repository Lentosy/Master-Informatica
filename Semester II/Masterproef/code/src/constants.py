...
PERSONS = ['BERT']
ACTIONS = ['EMERGENCY_STOP', 'NORMAL_STOP',
           'RH_MOVE_FORWARD', 'RH_MOVE_BACKWARD', 'RH_MOVE_RIGHT', 'RH_MOVE_LEFT',
           'LH_MOVE_FORWARD', 'LH_MOVE_BACKWARD', 'LH_MOVE_RIGHT', 'LH_MOVE_LEFT',
           'ROTATE_ABOUT_AXIS',
           'WAKE_UP', 'SLEEP',]
