...
\begin{itemize}
	...
	\begin{itemize}
		...
		$$||\textbf{u}||^2 = \textbf{u} \cdot \textbf{u}$$
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{$k$ zwaartepunten} poogt een leerverzameling $L$ op te delen in $k$ groepen $G_1, ..., G_k$, waarbij $k$ vooraf opgegeven is. Een klasse wordt voorgesteld door haar zwaartepunt $m_i$:
