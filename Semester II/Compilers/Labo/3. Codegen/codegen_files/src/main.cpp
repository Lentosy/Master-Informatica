...
cl::opt<OptLevel>
    OptimizationLevel(cl::desc("Choose optimization level:"),
                      cl::values(clEnumVal(O0, "Disable optimizations"),
                                 clEnumVal(O1, "Enable optimizations")),
                      cl::init(O1));
...
int main(int argc, char **argv) {
  ...
  driver.codegen(root.get(), OFN, OptimizationLevel == O1);
