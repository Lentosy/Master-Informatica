...
namespace BadmintonClientConsole.BadmindonServiceReference {
    ...
    public partial class SportClub : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private BadmintonClientConsole.BadmindonServiceReference.Tornooi[] TornooienField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public BadmintonClientConsole.BadmindonServiceReference.Tornooi[] Tornooien {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="BadmindonServiceReference.IBadmintonService")]
    public interface IBadmintonService {
        ...
        BadmintonClientConsole.BadmindonServiceReference.SportClub[] GetSportClubs();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBadmintonService/GetSportClubs", ReplyAction="http://tempuri.org/IBadmintonService/GetSportClubsResponse")]
        System.Threading.Tasks.Task<BadmintonClientConsole.BadmindonServiceReference.SportClub[]> GetSportClubsAsync();
        ...
        BadmintonClientConsole.BadmindonServiceReference.Lid[] GetLeden(int sportclubID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBadmintonService/GetLeden", ReplyAction="http://tempuri.org/IBadmintonService/GetLedenResponse")]
        System.Threading.Tasks.Task<BadmintonClientConsole.BadmindonServiceReference.Lid[]> GetLedenAsync(int sportclubID);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IBadmintonServiceChannel : BadmintonClientConsole.BadmindonServiceReference.IBadmintonService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class BadmintonServiceClient : System.ServiceModel.ClientBase<BadmintonClientConsole.BadmindonServiceReference.IBadmintonService>, BadmintonClientConsole.BadmindonServiceReference.IBadmintonService {
        ...
        public BadmintonClientConsole.BadmindonServiceReference.SportClub[] GetSportClubs() {
            return base.Channel.GetSportClubs();
        }
        
        public System.Threading.Tasks.Task<BadmintonClientConsole.BadmindonServiceReference.SportClub[]> GetSportClubsAsync() {
            return base.Channel.GetSportClubsAsync();
        }
        
        public BadmintonClientConsole.BadmindonServiceReference.Lid[] GetLeden(int sportclubID) {
            return base.Channel.GetLeden(sportclubID);
        }
        
        public System.Threading.Tasks.Task<BadmintonClientConsole.BadmindonServiceReference.Lid[]> GetLedenAsync(int sportclubID) {
