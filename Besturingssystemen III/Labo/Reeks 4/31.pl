...
@ARGV or die "geef klassenaam";


my $ClassName = $ARGV[0]; 
my $Class=$WbemServices->Get($ClassName,$typeLib->{"wbemFlagUseAmendedQualifiers"});# constante wbemFlagUseAmendedQualifiers wordt uit hash gehaald
