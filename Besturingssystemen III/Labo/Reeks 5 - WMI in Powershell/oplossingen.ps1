...
4.
# Bepaal voor Ã©Ã©n service het aantal services dat moet opgestart zijn, alvorens je die Ã©ne service kan opstarten.
...
8.#Herneem vorige oefening voor Ã©Ã©n instantie van de klasse (maakt niet uit welke instantie).
...
$Win32_LogicalDisk.Properties_.Count - $__SUPERCLASS.Properties_.Count # oops, opgave bedoelt gewoon $Win32_LogicalDisk.Properties_.Count, en niet de nieuwe attributen geÃ¯ntroduceerd door Win32_logicalDisk, ze moet maar duidelijker zijn
