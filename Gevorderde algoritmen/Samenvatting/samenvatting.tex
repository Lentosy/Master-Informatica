...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{ternary_searchtree}
...
= Voor elke positie $0 <= j <= t - p$ nagaan of $P$ in $T$ voorkomt startend vanaf positie $j$, en de opeenvolgende $p$ posities. \accentuate{brol}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \textbf{Random $r$}: Kies een willekeurig priemgetal $r$ uit een bepaald bereik. \todo{snap ik nie zo goe}
